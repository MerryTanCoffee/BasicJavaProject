...
<div class="slider">
  ...
  <div class="image-container" >
	<%  
	if(fileList.size()>=1){ %>
    <img src="<%=request.getContextPath()%>/download.do?fileSn=<%=fileList.get(0).getFileSn()%>&fileNo=<%=fileList.get(0).getFileNo()%>" style="margin-right:10px; width:480px;" height="500px;"     />  
	<%
	}else {
		%>
