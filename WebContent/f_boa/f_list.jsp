<%@page import="free.service.IFreeService"%>
<%@page import="free.service.FreeServiceImpl"%>
...
<!-- 			<div class="board_list"> -->
			<table id="myTable" border="1" margin="auto">
				...
				<tr class="top" >
					...
					<th class="title2" style="text-align: center;">제목</th>
					<th class="writer" style="text-align: center;">닉네임</th>
...
// 	alert( $(this).text() );
	location.href = "/demo2/free/list.do?page=" + $(this).text();
});
...
$('.next').on('click',function(){
	...
	location.href="/demo2/free/list.do?page=" + currentPage;
});
