...
<body>
	...
	<form action="MypageUpdate" method="post" enctype="multipart/form-data"
		...
		<table style="width: 100%">
			...
			<tr>
			<td>
				<a href="https://www.16personalities.com/ko/%EB%AC%B4%EB%A3%8C-%EC%84%B1%EA%B2%A9-%EC%9C%A0%ED%98%95-%EA%B2%80%EC%82%AC" target="_blank">성격유형검사</a>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td>
					...
					value="<%=mv.getMemAddr()%>" required autocomplete="off"
